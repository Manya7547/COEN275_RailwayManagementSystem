...
public class Passenger {
	...
	public Passenger(int userId, String emailId, int admin, String firstName, String lastName,
			List<TrainDetails> TrainDetails, List<Payment> payment) {
		super();
		this.userId = userId;
	...
	@Override
	public int hashCode() {
		return Objects.hash(admin, emailId, firstName, TrainDetails, lastName, payment, userId);
	}
	...
	public boolean equals(Object obj) {
		...
		return admin == other.admin && Objects.equals(emailId, other.emailId)
				&& Objects.equals(firstName, other.firstName) && Objects.equals(TrainDetails, other.TrainDetails)
