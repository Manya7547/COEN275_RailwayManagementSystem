...
const TrainSearch = lazy(() => import("../search/Train-search"));
const TrainBooking = lazy(() => import("../booking/Train-booking"));
...
const AdminEditTrain = lazy(() => import("../admin/AdminEditTrain"));
const AdminAddTrain = lazy(() => import("../admin/AdminAddTrain"));
            ...
            <Grid item xs={12} sm={12}>
              <ErrorBoundaries>
                <Suspense fallback={<div>Loading...</div>}>
                  <Switch>
                    <Route path={`/`} exact={true} component={TrainSearch} />
                    <Route
                      exact={true}
                      path={`/Train-search`}
                    ...
                    <Route
                      exact={true}
                      path={`/edit-Train/:TrainNumber`}
                      component={AdminEditTrain}
                    />
                    <Route
                      exact={true}
                      path={`/add-Train/`}
                      component={AdminAddTrain}
                    />
                  </Switch>
                </Suspense>
              </ErrorBoundaries>
