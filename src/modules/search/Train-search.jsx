...
import TrainListOneWay from "../../components/Train-list-grid/Train-list-one-way";
...
const TrainSearch = (props) => {
  ...
  const TrainList = useSelector((state) => state.TrainSearch.searchList);
    ...
    <Paper elevation={0} className={classes.paper}>
      <Grid container className={classes.centerContainer}>
        <RadioGroup row onChange={handleSelectTrip} value={selectTrip}>
          <FormControlLabel
            value="one"
            control={<Radio style={{ color: "#01377D" }} />}
            label="One Way"
          />
          <FormControlLabel
            value="both"
        ...
        {searchDone && (
          <TrainListOneWay TrainList={TrainList} bookNow={handleBookNow} />
        )}
      </Grid>
    </Paper>
  );
