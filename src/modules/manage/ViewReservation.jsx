...
const ViewReservation = (props) => {
  ...
  const fetchData = () => {
    ManageReservationService.getOneReservation(bookingId, userId).then(
      (res) => {
        ...
        setTrainNumber(res.data.passenger.TrainDetails[0].TrainNumber);
        setOriginalSeatDetails(res.data.passenger.TrainDetails[0].seat);
        setEditedFields(
  ...
  const handleEdit = () => {
    BookingService.getAllSeatsFromATrain(TrainNumber).then((res) => {
  ...
  const handleAddSeat = (seatNumber, seatClass, price) => {
    const updatedBookingDetail = {
      ...
      passenger: {
        ...
        TrainDetails: [
          {
            ...bookingDetail.passenger.TrainDetails[0],
            seat: {
      ...
      const updatedReservation = {
        ...
        passenger: {
          ...
          TrainDetails: [
            {
              TrainNumber:
                bookingDetail.passenger.TrainDetails[0].TrainNumber,
              departure: bookingDetail.departure,
              arrival: bookingDetail.arrival,
              departureDate:
                bookingDetail.passenger.TrainDetails[0].departureDate,
              arrivalDate: bookingDetail.passenger.TrainDetails[0].arrivalDate,
              departureTime:
                bookingDetail.passenger.TrainDetails[0].departureTime,
              arrivalTime: bookingDetail.passenger.TrainDetails[0].arrivalTime,
              seatAvailability:
                bookingDetail.passenger.TrainDetails[0].seatAvailability,
              seat: {
                seatNumber:
                  bookingDetail.passenger.TrainDetails[0].seat.seatNumber,
                seatClass:
                  bookingDetail.passenger.TrainDetails[0].seat.seatClass,
                price: bookingDetail.passenger.TrainDetails[0].seat.price,
                booked: true,
              },
            },
          ],
          payment: [
            {
              paymentId: bookingDetail.passenger.payment[0].paymentId,
              totalTravelFair:
                bookingDetail.passenger.TrainDetails[0].seat.price,
              TrainNumber:
                bookingDetail.passenger.TrainDetails[0].TrainNumber,
            },
          ],
        },
        TrainNumber: bookingDetail.passenger.TrainDetails[0].TrainNumber,
        departure: bookingDetail.departure,
      };
      console.log(
  ...
  <table className="confirmation-table">
    <tbody>
      ...
      <tr className="confirmation-table-row">
        ...
        <td className="confirmation-table-header second-column">
          {bookingDetail.passenger.TrainDetails[0].arrivalDate}
        </td>
      </tr>
      <tr className="confirmation-table-row">
        <td className="confirmation-table-header first-column">
        ...
        <td className="confirmation-table-header second-column">
          {bookingDetail.passenger.TrainDetails[0].arrivalTime}
        </td>
      </tr>
      <tr className="confirmation-table-row">
        <td className="confirmation-table-header first-column">
      ...
      <tr className="confirmation-table-row">
        ...
        <td className="confirmation-table-header second-column">
          {bookingDetail.passenger.payment[0] && bookingDetail.passenger.payment[0].totalTravelFair}
        </td>
      </tr>
    </tbody>
  </table>
  <Divider style={{ margin: "10px 0" }} />
            ...
            <div style={{ display: "flex", justifyContent: "flex-end" }}>
              <Button
                ...
                style={{ 
                  backgroundColor: "#01377D", color: "white",
                  marginRight: "10px",
              ...
              <div style={{ textAlign: "center", marginBottom: "20px" }}>
                ...
                <TableContainer component={Paper}>
                  <Table>
                    <TableHead>
                      <TableRow>
                        <TableCell style={{ backgroundColor: "#01377D", color: "white"  }}>
                          Seat Number
                        </TableCell>
                        <TableCell style={{ backgroundColor: "#01377D", color: "white"  }}>
                          Seat Class
      ...
      >
        ...
        <DialogActions style={{ justifyContent: "center" }}>
          <Button style={{ backgroundColor: "#01377D", color: "white" }} onClick={handleCloseDialog} color="primary">
            OK
          </Button>
        </DialogActions>
      </Dialog>
