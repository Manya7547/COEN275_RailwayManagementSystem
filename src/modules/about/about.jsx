...
import './about.css';
import bonVoyageImage from './BonVoyage.png'; // Import your image file
      ...
      <div className="content-container">
        ...
        <div className="row-container">
          <div className="text-container">
            <h1 className="about-header">About Us: Rail Express</h1>
            <p className="welcome-text">
              Welcome to Rail Express – Your Gateway to Seamless Journeys!
            </p>
            <p className="intro-text">
              At Rail Express, we don't just book Trains; we elevate your travel
              experience to new heights. Embark on a journey with us, where your
              comfort, convenience, and satisfaction take Train alongside you.
              We are more than just a Train reservation system; we are your
        ...
        <div className="text-container">
          ...
          <p className="story-text">
            ...
            redefining the way you explore the world, Rail Express is more than a
            platform; it's a vision. We started with a simple idea: to create a
            Train reservation system that mirrors the joy, excitement, and
          ...
          <div className="sets-apart-section">
            ...
            <p className="sets-apart-text">
              Rail Express is synonymous with unparalleled customer service. Our
          ...
          <p className="join-us-text">
            Rail Express invites you to join us on this extraordinary journey.
            ...
            new horizons together. Thank you for choosing Rail Express – Where Every
