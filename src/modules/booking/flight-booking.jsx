...
const TrainBooking = () => {
  const bookingData = useSelector((state) => state.TrainSearch.bookingDetails);
  ...
  return (
    <Grid container>
      <Grid item xs={12} className={classes.filterContainer}>
        <Typography variant="h6">{`Booking Confirmation for Train ${bookingData?.result?.airlineName} (${bookingData?.result?.TrainNumber})`}</Typography>
      </Grid>
