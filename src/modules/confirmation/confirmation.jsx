...
const Confirmation = () => {
  ...
  const TrainName = userInfoSession.selectedTrainNumber;
  ...
  return (
    <div className="confirmation-container">
      <Typography variant="h5" color="black">
        Your train is now set for an unforgettable journey with Rail Express. 
      </Typography>
      <br/>
      <Typography variant="h6" color="black">
      We are thrilled to confirm your booking. Here are the enchanting details of your adventure: ✨
      </Typography>
      <br/>
      <br/>
      <table className="confirmation-table">
        <tbody>
          ...
          <tr className="confirmation-table-row">
            <td className="confirmation-table-header first-column">Train Name</td>
            <td className="confirmation-table-data second-column">{TrainName}</td>
          </tr>
          <tr className="confirmation-table-row">
